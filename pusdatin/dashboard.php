                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="container" align="center">
                                <?php
                                $query = "SELECT * FROM book WHERE 1=1 AND JenisDok='E-Book'";
                                $judul = $_GET['judul'];
                                if ($judul) {
                                ...
                                while ($data = mysqli_fetch_array($query)) {
                                    ...
                                    echo '<div class="col-sm-4"><img class="img-thumbnail" src="assets/img/' . $data['Gambar'] . '" width="60%" /><br><b>' . $data['Judul'] . '</b><br><p>' . $data['Pengarang'] . '</p><a class="btn btn-primary" value="' . $data['ID'] . '" href="lihatdetail.php?ID=' . $data['ID'] . '">Detail</a><br></div>';
                                    if (($i) % $kolom == 0) {
                                        echo '</div>';
                                    }
                                    $i++;
