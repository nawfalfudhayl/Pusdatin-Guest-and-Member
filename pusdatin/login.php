                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form action="login-check.php" method="POST" class="login-email">
                                        ...
                                        <div class="input-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <button name="login" type="submit" value="Log in"
                                                class="btn btn-primary login">Login</button>
                                        </div>
                                    </form>
                                    <?php
