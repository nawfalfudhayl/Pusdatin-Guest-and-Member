            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu ms-auto ms-md-2 me-3 me-lg-4">
                    <div class="sb-sidenav-menu-heading mt-4 mb-2">
                        <div class="nav">
                            <form class="example" action="/pusdatin/e-referensi.php" style="margin:auto;max-width:300px">
                                <div class="sb-sidenav-menu-subheading mb-2">Judul</div>
                                <input type="text" placeholder="Cari buku/jurnal.." name="judul"
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="container" align="center">
                                <?php
                                $query = "SELECT * FROM book WHERE 1=1 AND JenisDok='E-Reference'";
                                $judul = $_GET['judul'];
                                if ($judul) {
