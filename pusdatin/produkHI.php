            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu ms-auto ms-md-2 me-3 me-lg-4">
                    <div class="sb-sidenav-menu-heading mt-4 mb-2">
                        <div class="nav">
                            <form class="example" action="/pusdatin/produkHI.php" style="margin:auto;max-width:300px">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="container" align="center">
                                <?php
                                $query = "SELECT * FROM book WHERE 1=1 AND JenisDok='ProductHI'";
                                $judul = $_GET['judul'];
                                if ($judul) {
                                ...
                                while ($data = mysqli_fetch_array($query)) {
                                    ...
                                    echo '<div class="col-sm-4"><img class="img-thumbnail" src="assets/img/' . $data['Gambar'] . '" width="60%" /><br><b>' . $data['Judul'] . '</b></div>';
                                    if (($i) % $kolom == 0) {
                                        echo '</div>';
                                    }
                                    $i++;
