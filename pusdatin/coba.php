                        ...
                        <div class="card-body">
                            <div class="container" align="center">
                                ...
                                while ($data = mysqli_fetch_array($query)) {
                                    ...
                                    echo '<div class="col-sm-4" ><img class="img-thumbnail" href="detail.php" src="assets/img/' . $data['Gambar'] . '" width="60%" /><br>' . $data['NamaBuku']  . $data['Pengarang'] . '</div>';
                                    if (($i) % $kolom == 0) {
                                        echo '</div>';
                                    }
                                    $i++;
